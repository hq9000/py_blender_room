...
WINDOW_MATERIAL_NAME: str = 'glass'
...
class Room1Scene(Scene):
    def _build(self):
        window_material = Material(name=WINDOW_MATERIAL_NAME)
        ...
        wall_a = Wall(thickness=0.03, height=4, windows=[window1, window2, window3], x0=0, y0=0, x1=0, y1=10)
